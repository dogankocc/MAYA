...
abstract class AppLocalizations {
  ...
  /// No description provided for @greedyMode.
  ///
  /// In en, this message translates to:
  /// **'Greedy (deterministic)'**
  String get greedyMode;
  ...
  /// No description provided for @errorHealth.
  ///
  /// In en, this message translates to:
  /// **'Cannot reach server'**
  String get errorHealth;
  ...
  ///
  /// In en, this message translates to:
  /// **'Start chatting with your local LLM model.'**
  ...
  String get modelLocal;

  String get modelOpenAi;
